...
phase: P0
updated_at: 2026-05-26T16:17:54
---
...
|---|---------|--------|------------|------|
| 1 | `통화정책` | `환율` | 0.164 | Fed_긴축_기대_강화 → 달러 강세 → 원_달러_환율_상승 |
| 2 | `지정학` | `유가` | 0.968 | 지정학적_리스크_확대 → 원유_공급_차질_우려 |
| 3 | `테크_AI_반도체` | `국내주식` | 0.960 | 반도체_섹터_대표주_영향 → 코스피_지수_반영 |
